...
namespace Foodeez.Infrastructure.Migrations
{
    ...
    [Migration("20260908234634_AddRecipeEnhancements")]
    partial class AddRecipeEnhancements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.AppSetting", b =>
                {
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.DayAnalysis", b =>
                {
                    ...
                    b.ToTable("day_analyses", (string)null);
                });
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.Property<Guid?>("EnhancedFromRecipeId")
                        .HasColumnType("char(36)");

                    b.Property<string>("EnhancementNotes")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("EnhancedFromRecipeId", "CreatedByUserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.SavedRecipe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.MealLog", b =>
                {
                    ...
                    b.OwnsOne("Foodeez.Domain.ValueObjects.MealAnalysis", "Analysis", b1 =>
                        {
                            b1.Property<Guid>("MealLogId")
                                .HasColumnType("char(36)");

                            b1.Property<string>("Completeness")
                                .IsRequired()
                                .HasMaxLength(500)
                                .HasColumnType("varchar(500)")
                                .HasColumnName("analysis_completeness");

                            b1.Property<string>("Fingerprint")
                                .IsRequired()
                                .HasMaxLength(64)
                                .HasColumnType("varchar(64)")
                                .HasColumnName("analysis_fingerprint");

                            b1.Property<DateTime>("GeneratedAt")
                                .HasColumnType("datetime(6)")
                                .HasColumnName("analysis_generated_at");

                            b1.Property<string>("Missing")
                                .IsRequired()
                                .HasColumnType("text")
                            ...
                            b1.Property<string>("Suggestions")
                                .IsRequired()
                                .HasColumnType("text")
            ...
            modelBuilder.Entity("Foodeez.Domain.Entities.Recipe", b =>
                {
                    b.HasOne("Foodeez.Domain.Entities.Recipe", null)
                        .WithMany()
                        .HasForeignKey("EnhancedFromRecipeId")
                        .OnDelete(DeleteBehavior.Cascade);
